...
CREATE TABLE `List` (
    ...
    `category` ENUM('NUTRITION_AND_DIET', 'SELF_CARE_AND_LIFESTYLE', 'EXERCISE_AND_MOVEMENT', 'HOBBIES_AND_RELAXATION', 'STRESS_MANAGEMENT', 'MEDICAL_CHECKUPS', 'HYDRATION', 'PREVENTIVE_HEALTH', 'MENTAL_AND_EMOTIONAL_WELLNESS', 'RELATIONSHIP_AND_SOCIAL_WELLNESS') NOT NULL,
